...
Flutter, geliştiricilere hızlı bir geliştirme deneyimi sunar. Hızlı bir şekilde hot-reload özelliği sayesinde, uygulamanın canlı önizlemelerini anında görebilirsiniz. Flutter, görsel olarak zengin uygulamalar oluşturmak için kullanabileceğiniz widgetlar ve araçlar sunar.
...
<div class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title"><?php echo "$description1" ?></h5>
    <p class="card-text"><?php echo "ORTALAMA AYLIK MAAŞ : $salary1" ?></p>
...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><?php echo "ORTALAMA AYLIK MAAŞ : $salary2" ?></p>
    <a href="#" class="btn btn-primary">DETAYLAR</a>
  </div>
  <div class="card-footer text-body-secondary">
    2 days ago
...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><?php echo "ORTALAMA AYLIK MAAŞ : $salary3" ?></p>
    <a href="#" class="btn btn-primary">DETAYLAR</a>
  </div>
  <div class="card-footer text-body-secondary">
    2 days ago
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjd04Dr2bl
</body>
</html>
